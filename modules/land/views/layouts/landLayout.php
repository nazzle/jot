         ...
         <div class="menuextras">
             ...
             <nav id="mainmenu" class="mainmenu">
                    <ul>
                        ...
                        <li class="active">
                            <a href="<?= Url::to(['/land'])?>"><?= Yii::t('app', 'Land Division'); ?></a>
                        </li>
                        <li>
                            <a href="<?= Url::to(['/land'])?>"><?= Yii::t('app', 'Home'); ?></a>
                        </li>
                        <li class="has-submenu">
                            <a href="#"><?= Yii::t('app', 'Pages +'); ?></a>
                            <div class="mainmenu-submenu">
                                <div class="mainmenu-submenu-inner"> 
                                    <div>
                                        <h4><?=Yii::t('app', 'HIGH COURT-LAND DIVISION') ?></h4>
                                        <ul>
                                     ...
                                     <div>
                                        <h4><?=Yii::t('app', 'ATTACHMENTS AND UPLOADS') ?></h4>
                                        <ul>
                                            <li><a href="#"><?=Yii::t('app', 'Plaint Form') ?></a></li>
                                            <li><a href="#"><?=Yii::t('app', 'Judgments') ?></a></li>
                                        </ul>
                                    </div>
                                    <div>
                                        <h4><?=Yii::t('app', 'FOR DIVISION STAFF') ?></h4>
                                        <ul>
                                            <li><a href="<?=Url::to(['default/management']) ?>"><i class="fa fa-lock"></i> <?=Yii::t('app', 'Login') ?></a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                        ...
                        <li>
                            <a href="<?= Url::to(['/site/home'])?>"><?= Yii::t('app', 'Judiciary Website'); ?></a>
                        </li>
                    </ul>
                </nav>
    </div>
            ...
            <div class="container">
                <div class="row">
                            <div class="col-footer col-md-3 col-xs-6">
                                <h3>Land Division Portifolio</h3>
                            ...
                            <div class="col-footer col-md-4 col-xs-6">
                                ...
                                <p class="contact-us-details">
                                    <b>Address:</b> 3rd Floor, NHC House<br/>
                                    <b>Samora</b> Avenue<br/>
