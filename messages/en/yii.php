...
return [
    ...
    'This is for users with Messenger privilege. Contact Admin' => '',
    ...
    'You can only edit the files that you sent.' => '',
    'You can upload at most {limit, number} {limit, plural, one{file} other{files}}.' => '',
    'You do not have privileges to perfom this action.Contact Admin.' => '',
